...
public class DatabaseInitialiser
{
    ...
    private static List<string> GetTableCreationCommands()
    {
        return new List<string>
        {
            ...
            "CREATE TABLE IF NOT EXISTS operation_pin (Id INTEGER PRIMARY KEY AUTOINCREMENT, Name TEXT, Address TEXT, Latitude REAL, Longitude REAL, PinType TEXT, StatusOrPurpose TEXT)"
        };
    }
}
